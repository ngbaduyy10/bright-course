...
<div class="d-flex align-items-center justify-content-center row detail">
    <div class="detail-container col-xl-7 col-lg-8 col-md-10 col-sm-12 p-0">
        <div class="row align-items-stretch detail-content" id="course-detail"></div>
    </div>
</div>
